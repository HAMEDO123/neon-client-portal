...
export function FurnitureSection({ furniture, showPrice }: { furniture: FullProject["furniture"]; showPrice: boolean }) {
  return (
    <SectionShell id="furniture">
      <SectionHeader eyebrow="Review" title="Furniture & Product Schedule" description="Every piece specified for your project, ready for procurement." />
      {furniture.length === 0 ? (
        <EmptyState className="mt-8" icon={Sofa} title="Furniture schedule coming soon" description="Selected furniture and products will appear here." />
      ) : (
            ...
            <div key={f.id} className="glass overflow-hidden rounded-2xl">
              ...
              <div className="p-4">
                ...
                <p className="mt-0.5 text-xs text-ink/45">
                  {f.space ? `${f.space} · ` : ""}Qty {f.quantity}
                </p>
